...
\begin{document}
	...
	\begin{enumerate}
		...
		That said, we can reasonably assume the quantitative variable in question (IQ) has a normal population distribution, as "Most people score near the average range, which is designed to fit into a normal distribution curve" (Kendra Cherry, MSEd).
